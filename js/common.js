...
const ERRORMSG_KANA_LST_FORMAT = "氏名カナ（姓）のフォーマットが正しくありません。"
const ERRORMSG_KANA_FST_FORMAT = "氏名カナ（名）のフォーマットが正しくありません。"
const ERRORMSG_BIRTHDAY_FORMAT = "生年月日のフォーマットが正しくありません。"
const ERRORMSG_HOME_TEL_FORMAT = "自宅電話番号のフォーマットが正しくありません。"
const ERRORMSG_MBL_TEL_FORMAT = "携帯電話番号のフォーマットが正しくありません。"
...
function checkMail(prm) {
    let mailptn = /^[A-Za-z0-9]{1}[A-Za-z0-9_.-]*@{1}[A-Za-z0-9_.-]{1,}\.[A-Za-z0-9]{1,}$/;
